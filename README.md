...
3. Run `./setup.sh` and reboot when prompted. By default, the Hailo-10 8G driver will be installed. To force the use of the Hailo-10 4G driver, run `./setup.sh H10-Driver=4G`
